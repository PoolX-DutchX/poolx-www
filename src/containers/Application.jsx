            ...
            <div className="full-height">
              ...
              {!isLoading && !hasError && (
                 ...
                 */}
                      ...
                      <Web3ProtectedRoute
                        exact
                        path="/pools/view/:poolAddress"
                        component={props => <ViewPool {...props} />}
                      />
                      <Web3ProtectedRoute
                        exact
                        path="/pools/contribute/:poolAddress"
                      ...
                      <CurrentUserProtectedRoute
                        ...
                        currentUser={currentUser}
                        component={props => (
                          <SignIn onSignIn={onSignIn} {...props} />
                        )}
                      />
                      <CurrentUserProtectedRoute
                        exact
                        ...
                        currentUser={currentUser}
                        component={props => (
                          <SignUp onSignIn={onSignIn} {...props} />
                        )}
                      />
                      <PrivateRoute
                        exact
              ...
              {!isLoading && hasError && (
                <center>
                  ...
                  <p>
                    PoolX could not load for some reason. Please try again...
                  </p>
                </center>
              )}
