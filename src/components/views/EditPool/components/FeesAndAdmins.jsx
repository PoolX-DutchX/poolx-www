        ...
        <div className="row">
          <div className="col-md-5">
            <span className="d-flex align-items-baseline">
              <Tooltip title="Requires blockchain transaction to change pool admin fee"  placement="bottom-start">
                <TextField
                  id="fee"
                  name="fee"
                  label="Pool fee"
              ...
              <div>
                <Link to={{
                  ...
                  <Button type="submit" variant="outlined" size="small" color="primary" style={{marginLeft: "1rem"}}>
                    Change
                  </Button>
                </Link>
              </div>
            </span>
            <Tooltip title="Fee payout currency is permanently set on smart contract"  placement="right">
          ...
          <div className="col-md-7 d-flex align-items-baseline">
            <Tooltip title="Requires blockchain transaction to change admin fee payout address"  placement="bottom-start">
              <TextField
            ...
            render={(fieldArrayHelpers) => {
              return (
                <div className="spacer-top-40">
                  <Tooltip title="Admin addresses permanently set on poolbase smart contract"  placement="top-start">
                    <div>
